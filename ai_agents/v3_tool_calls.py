...
travel_agent = Agent(
    ...
    """,
    model='gpt-4o-mini',
    tools=[get_weather_forecast], # tools
...
async def main():
    ...
    queries = [
        "I'm planning a trip to Los Angeles for 5 days with a budget of $2000. What should I do there and what is the weather going to look like?",
